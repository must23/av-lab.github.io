...
- How can we build safety within and around the core components of the AV decision-making pipeline?
...
- Exploit enabler technologies such as vehicle-to-everything (V2X) and build novel solutions to real-life problems
